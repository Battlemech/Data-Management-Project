...
namespace Main.Databases
{
    ...
    {
        private readonly Dictionary<string, List<Callback>> _callbacks = new Dictionary<string, List<Callback>>();

        public void AddCallback<T>(string id, ValueChanged<T> onValueChange, string name = "")
        {
        ...
        private void InvokeCallbacks(string id, byte[] serializedBytes)
        {
